...
public class FilterImpl implements HttpRequestHandler {
    ...
    public FilterImpl(String requestMethod, String context, HttpRequestHandler httpRequest, Express express) {
    ...
    public void handle(Request req, Response res) {
        ...
        ConcurrentHashMap<String, HttpRequestHandler> parameterListener = this.express.getParameterListener();
